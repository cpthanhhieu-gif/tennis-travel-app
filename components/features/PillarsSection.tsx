...
const pillars = [
  {
    ...
    description: "Sân ITF chuẩn quốc tế, HLV chuyên nghiệp, phân loại NTRP cá nhân hoá.",
  ...
  },
  {
    ...
    title: "Ẩm thực FEI",
    description: "Chef bản địa, Recovery meal thiết kế riêng cho từng mức NTRP.",
  ...
  },
  {
    icon: Building2,
    title: "Nghỉ dưỡng 5★",
    description: "Resort cao cấp, Spa phục hồi, Private dining view biển.",
    ...
    <section className="pt-[2.4rem] pb-[0.8rem] bg-neutral-03" aria-labelledby="pillars-title">
      ...
      <div className="px-[1.6rem] mb-[1.6rem]">
        ...
        <p className="text-neutral-40 text-[1.3rem] mt-[0.3rem]">
          Thiết kế toàn diện cho người chơi tennis đam mê
        </p>
      </div>
