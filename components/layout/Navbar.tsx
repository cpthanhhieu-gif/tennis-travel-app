...
export default function Navbar() {
  ...
  return (
    <nav
      ...
      className="hidden md:flex fixed top-0 left-0 right-0 z-40 bg-neutral-01 border-b border-neutral-10 h-[56px] items-center px-6 lg:px-8 shadow-[rgba(0,0,0,0.08)_0px_2px_8px]"
    >
      {/* Logo */}
      <Link
        href="/"
