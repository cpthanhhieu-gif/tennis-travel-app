  ...
  return (
    <>
      ...
      >
        ...
        <span className="relative w-[5.2rem] h-[5.2rem] rounded-full overflow-hidden shadow-[rgba(0,80,200,0.45)_0px_6px_24px] flex items-center justify-center bg-white">
          <img src="https://s3.hcm-1.cloud.cmctelecom.vn/static/web-travel/icon/bot-say-hi.png" alt="Ace AI" className="w-[85%] h-[85%] object-contain" />
          ...
          >
            ...
            <div className="shrink-0 flex items-center gap-[1.2rem] px-[2rem] pb-[1.4rem] border-b border-neutral-05">
              <div className="relative shrink-0">
                <div className="w-[4.4rem] h-[4.4rem] rounded-full overflow-hidden flex items-center justify-center bg-white">
                  <img src="https://s3.hcm-1.cloud.cmctelecom.vn/static/web-travel/icon/bot-say-hi.png" alt="Ace AI" className="w-[85%] h-[85%] object-contain" />
                </div>
            ...
            <div className="flex-1 overflow-y-auto px-[1.6rem] py-[1.6rem] space-y-[1.2rem]"
              ...
              {messages.length === 0 && !typing && (
                <div className="flex flex-col items-center pt-[2rem] pb-[1rem]">
                  <div className="w-[5.6rem] h-[5.6rem] rounded-full overflow-hidden mb-[1.2rem] flex items-center justify-center bg-white">
                    <img src="https://s3.hcm-1.cloud.cmctelecom.vn/static/web-travel/icon/bot-say-hi.png" alt="Ace AI" className="w-[85%] h-[85%] object-contain" />
                  </div>
