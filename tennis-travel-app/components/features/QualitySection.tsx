  ...
  const ROWS = [
    {
      ...
      desc: "Bạn được ở resort 5 sao, phục hồi tại spa sau thi đấu và thưởng thức private dining view biển — Vietravel đảm bảo trải nghiệm lưu trú trọn vẹn mỗi hành trình.",
    },
    {
      key: "FEI", fullName: "Food Experience Index", score: indices.find(i => i.label === "FEI")?.value ?? 89, max: 100, threshold: 85,
      desc: "Ăn ngon mà vẫn phục hồi tốt — menu FEI cá nhân hoá theo NTRP, chef bản địa với nguyên liệu trong bán kính 50km, có cooking class tùy chọn.",
    },
    {
    ...
    <section className="pt-[2.4rem] pb-[2.4rem] bg-neutral-01 border-t border-neutral-05" aria-labelledby="quality-title">
      <div className="px-[1.6rem]">
        <h2 id="quality-title" className="text-[1.8rem] font-bold text-neutral-90 mb-[0.3rem]">
          Vì sao chọn <span className="text-brand-primary">Vietravel Tennis</span>?
        </h2>
        <p className="text-neutral-40 text-[1.3rem] mb-[1.6rem]">
          30+ năm uy tín · Chuẩn chất lượng đo thực tế từng hành trình
        </p>
