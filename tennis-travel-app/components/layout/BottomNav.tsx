...
export default function BottomNav() {
  ...
  return (
    <nav
      ...
      className="md:hidden fixed bottom-0 left-0 right-0 z-[200] bg-white border-t border-neutral-10 pb-safe shadow-[rgba(0,0,0,0.10)_0px_-4px_16px]"
    >
          ...
          return (
            <li key={href} className="flex-1">
              <Link
                ...
                className="flex flex-col items-center justify-center gap-[0.3rem] py-[1rem] w-full min-h-[44px] focus:outline-none"
              >
                ...
                >
                  <Icon
                    size={24}
                    aria-hidden="true"
                    className={active ? "text-brand-primary" : "text-[#999999]"}
                  />
                </span>
                <span
                  className={`text-xs font-medium leading-none ${
                    active ? "text-brand-primary" : "text-[#999999]"
                  }`}
                >
                  {label}
                </span>
